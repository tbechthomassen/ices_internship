...
|   fleet-characterisation/__catch-graphs.R__	|   Produces graphs of STECF data on catches. An early script. Unelegant, needs to be rewritten. |
|   fleet-characterisation/__landings.graphs.R__	|  Produces graphs of STECF data on landings. An early script. Unelegant, needs to be rewritten. 	|
|   fleet-characterisation/__notes.Rmd__	|   The accumulated notes on work done for Mark DC and ICES August 3rd -- December 2nd 2015	|
|   	|   	|
|   	|   	|
