---
title: "Notes for using R script"
...
The Almigthy R (praised be its name) is able to interpret raw text-data, wihtout fucking it up - just be careful what you write in your `read.delim() `.