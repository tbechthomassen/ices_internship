...
---
  ...
  ## Notes guild assignment ##
  
  ###List of guilds###
  
  Guilds are assigned the each species useing an external file ("guilds.list"). The list contains species names (common & scientific), feeding guild and size guild.
  ...
  Size guilds are based on Fishbase data, using the size-guilds suggested by __Kristin Klesner__, and choosing max adult length as the determining factor for size guild.
