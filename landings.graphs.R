...
species_gear.summary <-
  ddply(
    land.data, c("snames", "gears.t"), summarise,
...
species.area.s <-
  ddply(
    land.data, c("snames", "cnames", "area"), summarise,
    sum2003 = sum(X2003, na.rm = TRUE),
    sum2004 = sum(X2004, na.rm = TRUE),
    sum2005 = sum(X2005, na.rm = TRUE),
    sum2006 = sum(X2006, na.rm = TRUE),
...
#summarise landings per ICES area
area.summary <-
  ddply(
    land.data, c("area"), summarise,
    sum2003 = sum(X2003, na.rm = TRUE),
    sum2004 = sum(X2004, na.rm = TRUE),
    sum2005 = sum(X2005, na.rm = TRUE),
    sum2006 = sum(X2006, na.rm = TRUE),
...
#calculate percentages per annual landings
...
land_guild.summary$"2003" <-
  (land_guild.summary$"sum2003" / sum(land_guild.summary$"sum2003") * 100)
land_guild.summary$"2004" <-
  (land_guild.summary$"sum2004" / sum(land_guild.summary$"sum2004") * 100)
land_guild.summary$"2005" <-
  (land_guild.summary$"sum2005" / sum(land_guild.summary$"sum2005") * 100)
land_guild.summary$"2006" <-
  (land_guild.summary$"sum2006" / sum(land_guild.summary$"sum2006") * 100)
land_guild.summary$"2007" <-
  (land_guild.summary$"sum2007" / sum(land_guild.summary$"sum2007") * 100)
land_guild.summary$"2008" <-
  (land_guild.summary$"sum2008" / sum(land_guild.summary$"sum2008") * 100)
land_guild.summary$"2009" <-
  (land_guild.summary$"sum2009" / sum(land_guild.summary$"sum2009") * 100)
land_guild.summary$"2010" <-
  (land_guild.summary$"sum2010" / sum(land_guild.summary$"sum2010") * 100)
land_guild.summary$"2011" <-
  (land_guild.summary$"sum2011" / sum(land_guild.summary$"sum2011") * 100)
land_guild.summary$"2012" <-
  (land_guild.summary$"sum2012" / sum(land_guild.summary$"sum2012") * 100)
land_guild.summary$"2013" <-
  (land_guild.summary$"sum2013" / sum(land_guild.summary$"sum2013") * 100)
...
guild_melt <-
  melt(
    land_guild.summary, id.vars = "guild", measure.vars = c(
